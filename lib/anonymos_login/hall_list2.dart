...
import 'package:eventsapp/anonymos_login/drawerr.dart';
...
class halles_screen2 extends StatefulWidget {
  halles_screen2({
    Key? key,
  }) : super(key: key);

  @override
  State<halles_screen2> createState() => _halles_screenState();
}

Future<List<Halls>> fetchHallsData() async {
  final response =
      await http.get(Uri.parse('http://192.168.43.9:8000/api/guest/hall'));
...
// ignore: camel_case_types
class _halles_screenState extends State<halles_screen2> {
